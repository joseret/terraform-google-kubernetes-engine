...
locals {
  ...
  # cluster_output_gke_backup_agent_config            = try(google_container_cluster.primary.addons_config[0].gke_backup_agent_config, null) == null ? false : var.gke_backup_agent_config
  # BETA features
