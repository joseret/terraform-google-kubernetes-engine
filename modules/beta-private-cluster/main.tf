...
locals {
  ...
  cluster_alias_ranges_cidr = var.add_cluster_firewall_rules ? { for range in toset(data.google_compute_subnetwork.gke_subnetwork[0]) : range.range_name => range.ip_cidr_range } : {}
